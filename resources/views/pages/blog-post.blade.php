        ...
        <div class="grid grid-cols-12">
            <div class="col-span-12">
                <div class="text-center text-white relative z-10">
                    ...
                    <h1 class="font-lora text-[36px] sm:text-[50px] md:text-[68px] lg:text-[50px] leading-tight xl:text-2xl font-medium">Blog Details </h1>
    ...
    <div class="container">
        ...
        <div class="grid grid-cols-12 mb-[-30px] gap-[30px] xl:gap-[50px]">
            <div class="col-span-12 md:col-span-6 lg:col-span-8 mb-[30px]">
                <img src="https://htmldemo.net/bery/bery/assets//images/blog-details/post2.png" class="w-auto h-auto" loading="lazy" alt="Elite Garden Resedence." width="770" height="465">
                <div class="mt-[55px] mb-[35px]">
                    <span
                        class="block leading-none font-normal text-[18px] text-secondary mb-[15px]">Morgan Smith on 20 May, 22</span>
                    <h2 class="font-lora leading-tight text-[22px] md:text-[28px] lg:text-[32px] text-primary mb-[10px] font-medium"> How To Estimate Your Rental Property Expenses.</h2>

                    <p class="max-w-[767px]">Huge number of propreties availabe here for buy, sell and Rent. Also you find here co-living property, lots opportunity you have to choose here and enjoy huge discount you can get. These cases are perfectly simpl and easy to distinguish. In a free hour, when our power of choice is untrammelled and when nothing prev ents our being able to do what we like best, every pleasure is to be welcomed and every pain avoided are cases are perfectly simple and easy to distinguish. In a free hour, when our power of choice</p>
                </div>
                ...
                <div class="xl:flex xl:flex-nowrap xl:justify-between gap-y-[30px] gap-x-[15px] xl:gap-x-[0px] mb-[30px] items-center">
                    <div class="grid grid-cols-12 gap-y-[30px] gap-x-[15px] xl:gap-x-[20px] xl:mr-[30px]">
                        <div class="col-span-7">
                            <a href="https://htmldemo.net/bery/bery/assets//images/properties-details/gallery/01.png" class="gallery-image">
                                <img class="object-cover rounded-[8px] w-full h-full" src="https://htmldemo.net/bery/bery/assets//images/properties-details/01.png" alt="gallery image" loading="lazy" width="270" height="187">
                            </a>
                        </div>
                        <div class="col-span-5">
                            <a href="https://htmldemo.net/bery/bery/assets//images/properties-details/gallery/03.png" class="gallery-image">
                                <img class="object-cover rounded-[8px] w-full h-full" src="https://htmldemo.net/bery/bery/assets//images/properties-details/03.png" alt="gallery image" loading="lazy" width="170" height="187">
                            </a>
                        </div>
                        <div class="col-span-5">
                            <a href="https://htmldemo.net/bery/bery/assets//images/properties-details/gallery/07.png" class="gallery-image">
                                <img class="object-cover rounded-[8px] w-full h-full" src="https://htmldemo.net/bery/bery/assets//images/properties-details/07.png" alt="gallery image" loading="lazy" width="170" height="187">
                            </a>
                        </div>
                        <div class="col-span-7">
                            <a href="https://htmldemo.net/bery/bery/assets//images/properties-details/gallery/05.png" class="gallery-image">
                                <img class="object-cover rounded-[8px] w-full h-full" src="https://htmldemo.net/bery/bery/assets//images/properties-details/05.png" alt="gallery image" loading="lazy" width="270" height="187">
                            </a>
                        </div>
                    </div>
                ...
                <p>Huge number of propreties availabe here for buy, sell and Rent. Also you find here co-living
                    ...
                    nothing prev
                    ents our being able to do what we like best, every pleasure is to be welcomed and every pain
                    avoided are
                ...
                <div class="flex flex-wrap items-center justify-between mt-[25px] mb-[-15px] pt-[20px] border-t border-[#E0E0E0]">
                    <div class="flex flex-wrap mb-[15px]">
                        ...
                        <a class="font-light hover:text-secondary ml-[5px]" href="#">Real Estate,</a>
                        <a class="font-light hover:text-secondary ml-[5px]" href="#"> Home,</a>
                        <a class="font-light hover:text-secondary ml-[5px]" href="#">Appartment,</a>
                        <a class="font-light hover:text-secondary ml-[5px]" href="#">Duplex Villa</a>
                    </div>

                    <div class="flex flex-wrap mb-[15px]">
                        <span class="text-secondary">Share:</span>
                        <ul class="inline-flex items-center justify-center">
                            <li class="ml-[15px]"><a href="#" class="w-[26px] h-[26px] transition-all rounded-full bg-[#E8F1FF] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
                ...
                <div class="grid grid-cols-12 mt-[70px]">
                    ...
                    <div class="col-span-12">
                        <h2 class="font-lora text-primary text-[24px] sm:text-[28px] capitalize font-medium">Feedback<span class="text-secondary">.</span>
                        </h2>

                        <ul class="mt-[50px] lg:mt-[70px]">
                            <li class="flex flex-wrap mb-[55px] sm:even:ml-[110px] md:even:ml-[0px] lg:even:ml-[110px] last:mb-0">
                                <img class="self-start mr-[35px] border border-primary rounded-[12px]" src="https://htmldemo.net/bery/bery/assets//images/commentor/02.png" width="78" height="80" loading="lazy" alt="image">
                                <div class="flex-1">
                                    <h4 class="text-primary font-lora text-[18px] leading-none mb-[15px]"> Stela Flemming, <span class="text-[14px] text-[#494949]">20 Jan, 2022</span> </h4>
                                    <p>Bary do a great job to find the perfect home. It’s very easy for every one to buy, sell or rent property we belive they continure their great service and
                                        appriciat.</p>
                            ...
                            <li class="flex flex-wrap mb-[55px] sm:even:ml-[110px] md:even:ml-[0px] lg:even:ml-[110px] last:mb-0">
                                <img class="self-start mr-[35px] border border-primary rounded-[12px]" src="https://htmldemo.net/bery/bery/assets//images/commentor/01.png" width="78" height="80" loading="lazy" alt="image">
                                <div class="flex-1">
                                    <h4 class="text-primary font-lora text-[18px] leading-none mb-[15px]">
                            ...
                            <li class="flex flex-wrap mb-[55px] sm:even:ml-[110px] md:even:ml-[0px] lg:even:ml-[110px] last:mb-0">
                                <img class="self-start mr-[35px] border border-primary rounded-[12px]" src="https://htmldemo.net/bery/bery/assets//images/commentor/03.png" width="78" height="80" loading="lazy" alt="image">
                                <div class="flex-1">
                                    <h4 class="text-primary font-lora text-[18px] leading-none mb-[15px]">
                        ...
                        <h2 class="font-lora text-primary text-[24px] sm:text-[28px] capitalize nt-[80px] lg:mt-[90px] font-medium">Leave a Message<span class="text-secondary">.</span>
                        </h2>
                        <div class="mt-[60px]">
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-4 mb-[30px]">
                <aside class="mb-[-40px]">
                    <div class="mb-[40px]">
                        <h3 class="text-primary leading-none text-[24px] font-lora underline mb-[30px] font-medium">Search<span class="text-secondary">.</span></h3>
                    ...
                    <div class="mb-[40px] flex flex-col">
                        <h3 class="text-primary leading-none text-[24px] font-lora underline mb-[30px] font-medium">Categories<span class="text-secondary">.</span></h3>
                        <div class="block mb-[-25px]">
                            <a href="#" class="font-light leading-[1.75] border border-primary border-opacity-60 rounded-[8px] pr-[20px] pl-[20px] py-[10px] hover:border-[#FD6400] hover:border-opacity-60  hover:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] bg-white flex flex-wrap items-center justify-between mb-[25px]"><span>Appartment</span> <span>35</span></a>
                            <a href="#" class="font-light leading-[1.75] border border-primary border-opacity-60 rounded-[8px] pr-[20px] pl-[20px] py-[10px] hover:border-[#FD6400] hover:border-opacity-60  hover:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] bg-white flex flex-wrap items-center justify-between mb-[25px]"><span>Family House</span> <span>50</span></a>
                            <a href="#" class="font-light leading-[1.75] border border-primary border-opacity-60 rounded-[8px] pr-[20px] pl-[20px] py-[10px] hover:border-[#FD6400] hover:border-opacity-60  hover:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] bg-white flex flex-wrap items-center justify-between mb-[25px]"><span>Duplex Villa</span> <span>38</span></a>
                            <a href="#" class="font-light leading-[1.75] border border-primary border-opacity-60 rounded-[8px] pr-[20px] pl-[20px] py-[10px] hover:border-[#FD6400] hover:border-opacity-60  hover:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] bg-white flex flex-wrap items-center justify-between mb-[25px]"><span>Farm House</span> <span>14</span></a>
                            <a href="#" class="font-light leading-[1.75] border border-primary border-opacity-60 rounded-[8px] pr-[20px] pl-[20px] py-[10px] hover:border-[#FD6400] hover:border-opacity-60  hover:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] bg-white flex flex-wrap items-center justify-between mb-[25px]"><span>Condo</span> <span>12</span></a>
                        </div>
                    </div>

                    <div class="mb-[40px]">
                        <h3 class="text-primary leading-none text-[24px] font-lora underline mb-[30px] font-medium">Popular Post<span
    class="text-secondary">.</span></h3>
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 gap-x-[30px] md:gap-x-[0px] relative">
                            <div class="flex items-center mb-[20px]">
                                <div class="relative w-[127px]">
                                    <a href="#" class="block w-full">
                                        <img src="https://htmldemo.net/bery/bery/assets//images/properties/properties-sm-1.png" class="w-full" alt="Post">
                                    </a>
                                </div>

                                <div class="text-left w-[calc(100%-151px)] ml-6">
                                    <span class="block leading-none font-light text-[12px] text-secondary mb-[8px]">22 June, 2022</span>
                                    <h3>
                                        <a href="blog-details.html" class="font-lora text-[16px] leading-[1.285] text-primary hover:text-secondary transition-all">Home Buying Process: A Comprehensive Guide.</a>
                                    </h3>
                                </div>
                            </div>
                            <div class="flex items-center text-center">
                                <div class="relative w-[127px]">
                                    <a href="#" class="block w-full">
                                        <img src="https://htmldemo.net/bery/bery/assets//images/properties/properties-sm-2.png" class="w-full" alt="Post">
                                    </a>
                                </div>

                                <div class="text-left w-[calc(100%-151px)] ml-6">
                                    <span class="block leading-none font-light text-[12px] text-secondary mb-[8px]">18 May, 2022</span>
                                    <h3>
                                        <a href="blog-details.html" class="font-lora text-[16px] leading-[1.285] text-primary hover:text-secondary transition-all">10 of the highest ROI Home Improvement Projects.</a>
                                    </h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-[40px] flex flex-col">
                        <h3 class="text-primary leading-none text-[24px] font-lora underline mb-[30px] font-medium">Archives<span class="text-secondary">.</span></h3>
                        <div class="mb-[-25px]">
                            <a href="#" class="font-light leading-[1.75] border border-primary border-opacity-60 rounded-[8px] pr-[20px] pl-[20px] py-[10px] hover:border-[#FD6400] hover:border-opacity-60  hover:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] bg-white flex flex-wrap items-center justify-between mb-[25px]"><span>January, 2022 </span> <span>35</span></a>

                            <a href="#" class="font-light leading-[1.75] border border-primary border-opacity-60 rounded-[8px] pr-[20px] pl-[20px] py-[10px] hover:border-[#FD6400] hover:border-opacity-60  hover:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] bg-white flex flex-wrap items-center justify-between mb-[25px]"><span>December, 2021</span> <span>50</span></a>

                            <a href="#" class="font-light leading-[1.75] border border-primary border-opacity-60 rounded-[8px] pr-[20px] pl-[20px] py-[10px] hover:border-[#FD6400] hover:border-opacity-60  hover:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] bg-white flex flex-wrap items-center justify-between mb-[25px]"><span>November, 2021</span> <span>38</span></a>

                            <a href="#" class="font-light leading-[1.75] border border-primary border-opacity-60 rounded-[8px] pr-[20px] pl-[20px] py-[10px] hover:border-[#FD6400] hover:border-opacity-60  hover:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] bg-white flex flex-wrap items-center justify-between mb-[25px]"><span>October, 2021</span> <span>14</span></a>

                            <a href="#" class="font-light leading-[1.75] border border-primary border-opacity-60 rounded-[8px] pr-[20px] pl-[20px] py-[10px] hover:border-[#FD6400] hover:border-opacity-60  hover:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] bg-white flex flex-wrap items-center justify-between mb-[25px]"><span>September, 2021</span> <span>12</span></a>
                        </div>
                    </div>
