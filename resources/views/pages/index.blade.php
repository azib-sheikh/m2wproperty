...
@section('content')
                                ...
                                <div class="grid grid-cols-12">
                                    ...
                                    <div class="col-span-12 lg:col-span-7 xl:col-span-6">
                                        <div class="relative mt-10 -right-6 md:mt-0 lg:absolute lg:right-0 lg:bottom-0 lg:w-3/4 xl:w-fit">
                                            <img class="hero_image w-full" src="https://htmldemo.net/bery/bery/assets/images/hero/home-1.png" width="866" height="879" alt="hero image">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <img  data-depth="0.1" src="https://htmldemo.net/bery/bery/assets/images/hero/shape4.svg" alt="">
  </span>
        </section>
        <!-- Hero section end -->
                ...
                <div class="grid grid-cols-12 gap-6 items-center">
                    <div class="col-span-12 lg:col-span-6">
                        ...
                        <div class="scene" data-relative-input="true">
                            <img data-depth="0.1" src="https://htmldemo.net/bery/bery/assets/images/about/about1.png" class="" loading="lazy" width="729" height="663" alt="about Image">
                        </div>
                    </div>
                            ...
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor"
                                ...
                                <div class="swiper-slide">
                                    <div class="overflow-hidden rounded-md drop-shadow-[0px_0px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                        <div class="relative">
                                            <a href="properties-details.html" class="block">
                                                <img src="https://htmldemo.net/bery/bery/assets/images/properties/properties8.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="Ruposibangla de parlosia.">
                                            </a>
                                            <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                                <button class="flex flex-wrap items-center bg-[rgb(11,44,61,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="https://htmldemo.net/bery/bery/assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                                <button class="flex flex-wrap items-center bg-[rgb(11,44,61,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="https://htmldemo.net/bery/bery/assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                            ...
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor"
                                ...
                                <div class="swiper-slide">
                                    <div class="overflow-hidden rounded-md drop-shadow-[0px_0px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                        <div class="relative">
                                            <a href="properties-details.html" class="block">
                                                <img src="https://htmldemo.net/bery/bery/assets/images/properties/properties9.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="Sinomen Studio Palace.">
                                            </a>
                                            <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                                <button class="flex flex-wrap items-center bg-[rgb(11,44,61,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="https://htmldemo.net/bery/bery/assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                                <button class="flex flex-wrap items-center bg-[rgb(11,44,61,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="https://htmldemo.net/bery/bery/assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                ...
                <div class="grid grid-cols-12 gap-3 sm:gap-[30px] items-center bg-primary z-[-2] lg:pl-[60px] lg:pr-0 lg:py-0 sm:pl-10 sm:pr-10 pl-5 pr-5 py-5 sm:py-12 rounded-[7px]">
                    ...
                    <div class="col-span-12 lg:col-span-6 text-center">
                        <div class="relative rounded-[24px] lg:pt-[45px] lg:pr-[45px] z-[1] lg:inline-block">
                            <div class="">
                                <img src="https://htmldemo.net/bery/bery/assets/images/video/shape-3.png" class="absolute top-[30px] right-[30px] z-[-1]" loading="lazy" width="50" height="60" alt="shape image">
                                <img src="https://htmldemo.net/bery/bery/assets/images/video/shape-2.png" class="absolute left-1/2 hidden lg:block lg:bottom-5 lg:-left-[160px]" loading="lazy" width="128" height="56" alt="Shape">
                            </div>
                            <div class="relative lg:-mb-16">
                                <div class="scene" data-relative-input="true">
                                    <img data-depth="0.1" src="https://htmldemo.net/bery/bery/assets/images/video/video.png" class="rounded-[24px] max-w-full" loading="lazy" width="507" height="349" alt="video image">
                                </div>
