    ...
    <div class="container">
        <div class="grid grid-cols-12 mb-[-30px] gap-[30px] xl:gap-[50px]">
            <div class="col-span-12 md:col-span-6 lg:col-span-8 mb-[30px]">
                <img src="https://htmldemo.net/bery/bery/assets/images/properties-details/post1.png" class="w-auto h-auto" loading="lazy" alt="Elite Garden Resedence." width="770" height="465">
                ...
                <ul class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 px-[15px] mx-[-15px] mt-[40px]">
                    <li class="flex flex-wrap items-center mb-[25px]">
                        <img class="mr-[15px]" src="https://htmldemo.net/bery/bery/assets/images/about/check.png" loading="lazy" alt="icon" width="20" height="20">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-[30px]">
                    <div class="text-center">
                        <img src="https://htmldemo.net/bery/bery/assets/images/floor-plan/floor1.png" alt="Floor Plan">
                        <p>Ground floor</p>
                    </div>

                    <div class="text-center">
                        <img src="https://htmldemo.net/bery/bery/assets/images/floor-plan/floor3.png" alt="Floor Plan">
                        <p>1st Floor</p>
                    </div>
                </div>
                            ...
                            <ul>
                                ...
                                <li class="flex flex-wrap items-center justify-between pb-[25px] mb-[25px] border-b border-[#016450]">
                                    <div class="flex flex-wrap mb-[20px] sm:mb-[0px] md:mb-[20px]">
                                        <img class="self-start mr-[40px]" src="https://htmldemo.net/bery/bery/assets/images/icon/medist.png" loading="lazy" width="54" height="68" alt="logo">
                                        <div class="flex-1">
                                ...
                                <li class="flex flex-wrap items-center justify-between pb-[25px] mb-[25px] border-b border-[#016450]">
                                    <div class="flex flex-wrap mb-[20px] sm:mb-[0px] md:mb-[20px] lg:mb-[0px]">
                                        <img class="self-start mr-[40px]" src="https://htmldemo.net/bery/bery/assets/images/icon/healthcare.png" loading="lazy" width="63" height="68" alt="logo">
                                        <div class="flex-1">
                                            <h4 class="text-primary font-lora text-[18px] leading-none mb-[5px]">
                                                Mediset Hospital Ltd.</h4>
                                            <span class="text-[14px] leading-none">(0.5 km distance)</span>
                                ...
                                <li class="flex flex-wrap items-center justify-between">
                                    <div class="flex flex-wrap mb-[20px] sm:mb-[0px] md:mb-[20px]">
                                        <img class="self-start mr-[40px]" src="https://htmldemo.net/bery/bery/assets/images/icon/medihealth.png" loading="lazy" width="56" height="66" alt="logo">
                                        <div class="flex-1">
                                            <h4 class="text-primary font-lora text-[18px] leading-none mb-[5px]">
                                                Mediset Hospital Ltd.</h4>
                                            <span class="text-[14px] leading-none">(0.5 km distance)</span>
                    ...
                    <div class="col-span-12">
                        ...
                        <ul class="mt-[50px] lg:mt-[70px]">
                            <li class="flex flex-wrap mb-[55px] sm:even:ml-[110px] md:even:ml-[0px] lg:even:ml-[110px] last:mb-0">
                                <img class="self-start mr-[35px] border border-primary rounded-[26px]" src="https://htmldemo.net/bery/bery/assets/images/commentor/01.png" width="78" height="80" loading="lazy" alt="image">
                                <div class="flex-1">
                                    <h4 class="text-primary font-lora text-[18px] leading-none mb-[5px]">
                            ...
                            <li class="flex flex-wrap mb-[55px] sm:even:ml-[110px] md:even:ml-[0px] lg:even:ml-[110px] last:mb-0">
                                <img class="self-start mr-[35px] border border-primary rounded-[26px]" src="https://htmldemo.net/bery/bery/assets/images/commentor/02.png" width="78" height="80" loading="lazy" alt="image">
                                <div class="flex-1">
                                    <h4 class="text-primary font-lora text-[18px] leading-none mb-[5px]">
                            ...
                            <li class="flex flex-wrap mb-[55px] sm:even:ml-[110px] md:even:ml-[0px] lg:even:ml-[110px] last:mb-0">
                                <img class="self-start mr-[35px] border border-primary rounded-[26px]" src="https://htmldemo.net/bery/bery/assets/images/commentor/03.png" width="78" height="80" loading="lazy" alt="image">
                                <div class="flex-1">
                                    <h4 class="text-primary font-lora text-[18px] leading-none mb-[5px]">
                                        ...
                                        <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_3px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center mb-[40px]">
                                            <div class="relative">
                                                ...
                                                <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                                    <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="https://htmldemo.net/bery/bery/assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                                    <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="https://htmldemo.net/bery/bery/assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                                                </div>
    ...
    class="text-secondary">.</span></h3>
                        ...
                        <div class="grid sm:grid-cols-2 lg:grid-cols-2 gap-x-[20px] mb-[-20px]">
                            ...
                            <div class="text-center group mb-[30px]">
                                <div class="relative z-[1] rounded-[6px_6px_0px_0px]">
                                    <a href="agent-details.html" class="block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-[#016450] before:w-full before:h-[calc(100%_-_30px)] before:z-[-1] before:rounded-[6px_6px_0px_0px]">
                                        <img src="https://htmldemo.net/bery/bery/assets/images/team/person3.png" class="w-full object-contain block mx-auto" loading="lazy" width="130" height="154" alt="Albert S. Smith">
                                    </a>
                                </div>
                            ...
                            <div class="text-center group mb-[30px]">
                                <div class="relative z-[1] rounded-[6px_6px_0px_0px]">
                                    <a href="agent-details.html" class="block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-[#016450] before:w-full before:h-[calc(100%_-_30px)] before:z-[-1] before:rounded-[6px_6px_0px_0px]">
                                        <img src="https://htmldemo.net/bery/bery/assets/images/team/person4.png" class="w-full object-contain block mx-auto" loading="lazy" width="130" height="154" alt="Amelia Margaret">
                                    </a>
                                </div>
