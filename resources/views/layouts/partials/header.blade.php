...
<body class="font-karla text-body text-tiny">
    <div class="overflow-hidden">
        ...
        <header id="sticky-header" class="absolute left-0 top-[15px] lg:top-[30px] xl:top-[40px] w-full z-10">
            <div class="container">
                ...
                ">
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="index.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px] rounded-t-[12px]">Home
                                                    01</a>
                                            </li>
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="index-2.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px]">Home
                                                    02</a>
                                            </li>
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="index-3.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px]">Home
                                                    03</a>
                                            </li>
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="index-4.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px]">Home
                                                    04</a>
                                            </li>
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="index-5.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px]">Home
                                                    05</a>
                                            </li>
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="index-6.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px] rounded-b-[12px]">Home
                                                    06</a>
                                            </li>
                                        </ul>
                                    </li>
            ...
            ">
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="about.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px] rounded-t-[12px]">about 01</a>
                                            </li>

                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="about-v2.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px] rounded-b-[12px]">about 02</a>
                                            </li>
                                        </ul>
            ...
            " style="background-image: url('assets/images/mega-menu/image.png');">
                                            ...
                                            <li class="mr-[70px]">
                                                <ul>
                                                    <li class="text-primary underline font-lora mb-[30px]">Properties</li>
                                                    <li class="mb-[25px] last:mb-0">
                                                        <a href="properties-v1.html" class="font-lora text-[14px] hover:text-secondary">Properties v1</a>
                                                    </li>
                                                    <li class="mb-[25px] last:mb-0">
                                                        <a href="properties-v2.html" class="font-lora text-[14px] hover:text-secondary">Properties v2</a>
                                                    </li>

                                                    <li class="mb-[25px] last:mb-0">
                                                        <a href="add-properties.html" class="font-lora text-[14px] hover:text-secondary">Add properties</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            ...
                                            <li class="mr-[70px]">
                                                <ul>
                                                    <li class="text-primary underline font-lora mb-[30px]">Properties1 with sidebar</li>
                                                    <li class="mb-[25px] last:mb-0">
                                                        <a href="properties-left-side-bar.html" class="font-lora text-[14px] hover:text-secondary">Properties left side bar</a>
                                                    </li>
                                                    <li class="mb-[25px] last:mb-0">
                                                        <a href="properties-right-side-bar.html" class="font-lora text-[14px] hover:text-secondary">Properties right side bar</a>
                                                    </li>

                                                    <li class="mb-[25px] last:mb-0">
                                                        <a href="properties-list-left-side-bar.html" class="font-lora text-[14px] hover:text-secondary">Properties list left side bar</a>
                                                    </li>

                                                    <li class="mb-[25px] last:mb-0">
                                                        <a href="properties-list-right-side-bar.html" class="font-lora text-[14px] hover:text-secondary">Properties list
                                                            right side bar</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            ...
                                            <li>
                                                <ul>
                                                    ...
                                                    <li class="mb-[25px] last:mb-0">
                                                        <a href="properties-details.html" class="font-lora text-[14px] hover:text-secondary">Properties details</a>
                                                    </li>
                                    ...
                                    <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                        ...
                                        <a href="#" class="sticky-dark transition-all text-white hover:text-secondary">Pages</a>
            ...
            ">
                                            ...
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="service.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px] rounded-t-[12px]">Service</a>
                                            </li>

                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="single-service.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px]">single service</a>
                                            </li>

                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="login.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px]">login</a>
                                            </li>
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
            ...
            ">
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="agency.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px] rounded-t-[12px]">agency</a>
                                            </li>
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="create-agency.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px]">create
                                                    agency</a>
                                            </li>

                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="agent.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px]">agent</a>
                                            </li>

                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="agency-details.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px]">agency
                                                    details</a>
                                            </li>

                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="agent-details.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px] rounded-b-[12px]">agent
                                                    details</a>
                                            </li>
            ...
            ">
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="blog-grid.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px] rounded-t-[12px]">blog
                                                    grid</a>
                                            </li>
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="blog-grid-left-side-bar.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px]">blog
                                                    grid left side bar</a>
                                            </li>
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="blog-grid-right-side-bar.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px]">blog
                                                    grid right side bar</a>
                                            </li>
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="blog-details.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-secondary hover:text-white text-center my-[-1px] rounded-b-[12px]">blog
                                                    details</a>
                                            </li>
                                ...
                                <ul class="flex flex-wrap items-center">
                                    <li class="sm:mr-5 xl:mr-[20px] relative group"><a href="#">
                                            <img src="https://htmldemo.net/bery/bery/assets//images/user/avater.png" loading="lazy" width="62" height="62" alt="avater">
                                        </a>
